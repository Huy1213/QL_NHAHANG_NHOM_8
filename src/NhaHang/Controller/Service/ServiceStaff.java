...
public class ServiceStaff {
    ...
    public ModelNhanVien getStaff(int userID) throws SQLException {
        ...
        String sql = "SELECT ID_NV, TenNV, NgayVL AS Ngay, SDT, Chucvu, ID_NQL FROM NhanVien WHERE ID_ND=?";
    ...
    public ArrayList<ModelPNK> MenuPNK() throws SQLException {
        ...
        String sql = "SELECT ID_NK,ID_NV,CONVERT(VARCHAR(10), NgayNK, 105) AS Ngay,Tongtien FROM PhieuNK ORDER BY ID_NK";
        PreparedStatement p = con.prepareStatement(sql);
        ResultSet r = p.executeQuery();
        while (r.next()) {
            int idNK = r.getInt(1);
    ...
    public ModelPNK getPNKbyID(int id) throws SQLException {
        ModelPNK data = null;
        String sql = "SELECT ID_NK,ID_NV,CONVERT(VARCHAR(10), NgayNK, 105) AS Ngay,Tongtien FROM PhieuNK WHERE ID_NK=?";
        PreparedStatement p = con.prepareStatement(sql);
        p.setInt(1, id);
        ResultSet r = p.executeQuery();
        while (r.next()) {
    ...
    public int getTongtienNK() throws SQLException {
       ...
       String sql = "SELECT SUM(Tongtien) FROM PhieuNK WHERE NgayNK=CONVERT(DATE, ?, 105)";
        PreparedStatement p = con.prepareStatement(sql);
    ...
    public ArrayList<ModelPXK> MenuPXK() throws SQLException {
        ...
        String sql = "SELECT ID_XK,ID_NV,CONVERT(VARCHAR(10), NgayXK, 105) AS Ngay FROM PhieuXK ORDER BY ID_XK";
        PreparedStatement p = con.prepareStatement(sql);
        ResultSet r = p.executeQuery();
        while (r.next()) {
            int idXK = r.getInt(1);
    ...
    public ModelPXK getPXKbyID(int id) throws SQLException {
        ModelPXK data = null;
        String sql = "SELECT ID_XK,ID_NV,CONVERT(VARCHAR(10), NgayXK, 105) AS Ngay FROM PhieuXK WHERE ID_XK=?";
        PreparedStatement p = con.prepareStatement(sql);
        p.setInt(1, id);
        ResultSet r = p.executeQuery();
        while (r.next()) {
    ...
    public int getSLPXK() throws SQLException {
        int sl = 0;
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-YYYY");
        String sql = "SELECT COUNT(*) FROM PhieuXK WHERE NgayXK=CONVERT(DATE, ?, 105);";
        PreparedStatement p = con.prepareStatement(sql);
        p.setString(1, simpleDateFormat.format(new Date()));
        ResultSet r = p.executeQuery();
        while (r.next()) {
    ...
    public void InsertPNK_CTNK(ModelPNK pnk, ArrayList<ModelKho> list) throws SQLException {
        ...
        String sql = "INSERT INTO PhieuNK(ID_NK,ID_NV,NgayNK) VALUES (?,?,CONVERT(DATE, ?, 105))";
        PreparedStatement p = con.prepareStatement(sql);
    ...
    public void InsertPXK_CTXK(ModelPXK pxk, ArrayList<ModelKho> list) throws SQLException {
        //Thêm phiếu nhập kho
        String sql = "INSERT INTO PhieuXK(ID_XK,ID_NV,NgayXK) VALUES (?,?,CONVERT(DATE, ?, 105))";
        PreparedStatement p = con.prepareStatement(sql);
    ...
    public ArrayList<ModelKhachHang> MenuKH() throws SQLException {
        ...
        String sql = "SELECT ID_KH, TenKH, Ngaythamgia AS Ngay, Doanhso, Diemtichluy FROM KhachHang";
        PreparedStatement p = con.prepareStatement(sql);
        ResultSet r = p.executeQuery();
        while (r.next()) {
    ...
    public void updatetrangthaidangdung(int idBan) throws SQLException {
