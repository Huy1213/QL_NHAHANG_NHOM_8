...
import NhaHang.Controller.Event.EventMenu;
import NhaHang.Controller.Event.EventMenuSelected;
import NhaHang.Model.ModelMenu;
import NhaHang.View.Swing.CustomScrollBar.ScrollBarCustom;
import NhaHang.View.Swing.MenuAnimation;
import NhaHang.View.Swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/table.png")), "Đặt bàn", "Sảnh"));
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource(""))); // NOI18N
        logo.setText("<html> Sai Gon Restaurant</html>");
