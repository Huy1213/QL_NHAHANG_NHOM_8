...
import NhaHang.View.Swing.ButtonOutLine;
import NhaHang.View.Swing.ImageLogo;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        logo.setIcon(new ImageIcon(getClass().getResource("/Icons/logo_nhahang.png")));
        add(logo);
        ...
        subtitle= new JLabel("Sai Gon Restaurant");
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gp = new GradientPaint(0, 0, Color.decode("#FACE9C"), 0, getHeight(), Color.decode("#EC870E"));
        g2.setPaint(gp);
