...
package NhaHang.View.Main_Frame;
...
import NhaHang.View.Form.Customer_Form.TableMenu_Form;
        ...
        menu.addEvent(new EventMenuSelected(){
            ...
            public void menuSelected(int menuIndex, int subMenuIndex)  {
                switch (menuIndex) {
                    ...
                    case 1 -> {
                        switch (subMenuIndex) {
                            case 0 -> main.showForm(new FoodMenu_Form("Cuu",user));
                            case 1 -> main.showForm(new FoodMenu_Form("Bo",user));
                            case 2 -> main.showForm(new FoodMenu_Form("Combo",user));
                            case 3 -> main.showForm(new FoodMenu_Form("Cua",user));
                            case 4 -> main.showForm(new FoodMenu_Form("MonHan",user));
                            case 5 -> main.showForm(new FoodMenu_Form("BanhNgot",user));
                            case 6 -> main.showForm(new FoodMenu_Form("Salad",user));
                            case 7 -> main.showForm(new FoodMenu_Form("Scorpio",user));
                            case 8 -> main.showForm(new FoodMenu_Form("Ngua",user));
                            case 9 -> main.showForm(new FoodMenu_Form("De",user));
                            case 10 -> main.showForm(new FoodMenu_Form("DoUong",user));
                            case 11 -> main.showForm(new FoodMenu_Form("Ca",user));
                            default -> {
                            }
                        }
                    }
                    ...
                    case 2 -> main.showForm(new AccountC_Form(user));              
                    case 3 -> {
