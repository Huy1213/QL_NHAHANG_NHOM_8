package NhaHang.View.Form.Staff_Form.WarehouseStaff;
...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new NhaHang.View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new NhaHang.View.Swing.Table();
        cmdAdd = new NhaHang.View.Swing.Button();
        cmdCT = new NhaHang.View.Swing.Button();
    ...
    private NhaHang.View.Swing.Button cmdCT;
    ...
    private NhaHang.View.Swing.Table tablePXK;
    private NhaHang.View.Swing.MyTextField txtSearch;
    private NhaHang.View.Swing.MyTextField txtslPXK;
