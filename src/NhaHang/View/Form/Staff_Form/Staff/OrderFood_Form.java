...
import NhaHang.View.Component.Customer_Component.CardMonAn;
...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    // Thực hiện các hành động liên quan đến HoaDon ở đây
        } else {
            // Hiển thị thông báo
            JOptionPane.showMessageDialog(this, "Không có hóa đơn cho khách hàng này!", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void initComponents() {
        ...
        TypeMenu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cuu", "Bo", "Combo", "Cua", "MonHan", "BanhNgot", "Salad", "Scorpio", "Ngua", "De", "DoUong", "Ca" }));
    ...
    private NhaHang.View.Swing.MyTextField txtKH;
    private NhaHang.View.Swing.MyTextField txtSearch;
    private NhaHang.View.Swing.MyTextField txtTableID;
