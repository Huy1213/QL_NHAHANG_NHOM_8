...
public class Bill_Form extends javax.swing.JPanel {
    ...
    public void initTable(){
        try {
            ...
            for(ModelHoaDon data:list){  
                tableHD.addRow(new Object[]{data.getIdHoaDon(),data.getNgayHD(),df.format(data.getTongtien())+"đ"});
            }
        }catch(SQLException ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        txtPoint = new NhaHang.View.Swing.MyTextField();
        ...
        tableHD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Hóa Đơn", "Ngày HĐ", "Tổng tiền"
            }
        ) {
    ...
    private NhaHang.View.Swing.MyTextField txtPoint;
